...
* \~japanese
* @file
* @brief AILIA Audio Unity Plugin Native Interface
 ...
 */
    public const Int32 AILIA_AUDIO_WIN_TYPE_HANN = (1);
/**
 * \~japanese
 * 窓関数に hamming 窓を使う
 *
 ...
 */
    public const Int32 AILIA_AUDIO_WIN_TYPE_HAMMING = (2);
 ...
 */
    public const Int32 AILIA_AUDIO_STFT_CENTER_NONE = (0);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_STFT_CENTER_ENABLE = (1);
/**
 * \~japanese
 * STFT の際、sample_n の前後に fft_n/2 の padding(zero)
 * を入れ、さらにhop_n処理単位になるように後方padding(zero)で合わせる
 *
 * \~english
 * for the STFT, insert a padding (zeros) of fft_n/2 before and after the sample_n samples, and also pad at the
 * end with zeros to process in units of hop_n
 */
    public const Int32 AILIA_AUDIO_STFT_CENTER_SCIPY_DEFAULT = (2);
 ...
 */
    public const Int32 AILIA_AUDIO_FFT_NORMALIZE_NONE = (0);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_FFT_NORMALIZE_LIBROSA_COMPAT = (1);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_FFT_NORMALIZE_PYTORCH_COMPAT = (1);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_FFT_NORMALIZE_SCIPY_COMPAT = (2);
 ...
 */
    public const Int32 AILIA_AUDIO_MEL_NORMALIZE_NONE = (0);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_MEL_NORMALIZE_ENABLE = (1);
 ...
 */
    public const Int32 AILIA_AUDIO_MEL_SCALE_FORMULA_HTK = (1);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_MEL_SCALE_FORMULA_SLANYE = (0);
 ...
 */
    public const Int32 AILIA_AUDIO_PHASE_FORM_COMPLEX = (1);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_PHASE_FORM_REAL = (0);
 ...
 */
    public const Int32 AILIA_AUDIO_FILTFILT_PAD_NONE = (0);
/**
 * \~japanese
 * ゼロ位相フィルタ処理の際、padding はodd
 *
 * \~english
 * During zero-phase filtering, pad with an odd reflection (substract the reflected values from two times the
 * edge value)
 */
    public const Int32 AILIA_AUDIO_FILTFILT_PAD_ODD = (1);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_FILTFILT_PAD_EVEN = (2);
/**
 * \~japanese
 ...
 */
    public const Int32 AILIA_AUDIO_FILTFILT_PAD_CONSTANT = (3);
